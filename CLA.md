...
Thank you for contributing to AvialSync. This document explains the terms your
contribution is accepted under. It is short on purpose.
...
1. **You wrote it, or you have the right to submit it.** If your employer owns
...
4. **You grant a patent licence** covering any patent claims you control that
   your contribution necessarily infringes, on the same terms.
...
Add this line to your first pull request description:

```
I have read CLA.md and I accept its terms for this and my future contributions.
```

One line covers your later pull requests too. If you would rather not agree,
open an issue describing the change instead — a description costs nothing and is
often the more useful contribution anyway.

## If you are unsure

Ask before writing the code, at <anzal.ks@gmail.com>. That is cheaper than
finding out after the work is done.
