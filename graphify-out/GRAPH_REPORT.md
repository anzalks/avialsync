# Graph Report - avialview  (2026-08-27)
...
## Summary
- 6181 nodes · 11643 edges · 277 communities (260 shown, 17 thin omitted)
...
8. `PyramidBuilder` - 72 edges
9. `Transport` - 71 edges
...
### Community 0 - "PlotPane"
Cohesion: 0.02
Nodes (63): PlotPane, InfiniteLine, Path, QAction, QEvent, QResizeEvent, QWidget, Keep pyqtgraph's canvas aligned with an application palette change. (+55 more)

### Community 1 - "MainWindow"
Cohesion: 0.02
Nodes (48): QMainWindow, on_data_export_error(), on_data_export_thread_finished(), on_region_stats_error(), on_region_stats_finished(), on_region_stats_thread_finished(), on_snapshot_error(), on_snapshot_thread_finished() (+40 more)

### Community 2 - "test_loaders_open_ephys.py"
Cohesion: 0.04
Nodes (95): Return per-frame exposure evidence from a ``frame_number,timestamp`` sidecar.…, read_frame_timestamps(), _drop(), _layout(), datetime, fixture, Path, Tests for the Open Ephys session plugin and the neo ingest path behind it.… (+87 more)

### Community 3 - "plot_pane.py"
Cohesion: 0.04
Nodes (63): GraphicsLayoutWidget, PlotItem, Annotation markers: point and range, with list panel and CSV export., Compact shared controls for the time-series plot stack., Stateful interaction controller for plot measurements, markers, and menus., ContextChoice, Any, InfiniteLine (+55 more)
...
### Community 5 - "LoaderRegistry"
Cohesion: 0.04
Nodes (58): _Capability, LoaderRegistry, ModuleType, Path, Protocol, Plugin registry and discovery., Add each built-in class in *specs*, reporting any that will not import. A…, Add every class published under *group*, skipping ones that fail. Deduplicates… (+50 more)

### Community 6 - "AOLVideoExtractionLoader"
Cohesion: 0.06
...
### Community 7 - "VideoPane"
Cohesion: 0.04
Nodes (40): DecodeWorker, ndarray, QCloseEvent, QObject, QPaintEvent, QWidget, setter, Slot (+32 more)

### Community 8 - "SourceOpenError"
Cohesion: 0.05
Nodes (48): ABC, AvialSyncError, CodecUnsupportedError, FileUnreadableError, LoaderContractError, MissingColumnError, NonMonotonicTimeError, Any (+40 more)

### Community 9 - ".__init__"
Cohesion: 0.04
Nodes (42): QTreeWidgetItem, QVBoxLayout, Register window-scoped QActions for all keyboard-only shortcuts (D-022). Rules…, _make_empty_inspection(), QFrame, QWidget, Left Sidebar / Inspector Pane., Set a channel checkbox and return whether this source owns it. (+34 more)

### Community 10 - "DECISIONS.md — lightweight ADR log"
Cohesion: 0.03
...
### Community 11 - "PyAVReader"
Cohesion: 0.04
Nodes (45): ndarray, Path, VideoStream, PyAVReader, Demux one pass to collect presentation timestamps and keyframes. Demux only —…, Presentation timestamps in source seconds, display order., Number of frames the container actually carries timestamps for., The decoded video stream, for callers building format metadata. (+37 more)

### Community 12 - "Tracking3DCanvas"
Cohesion: 0.05
Nodes (35): QWheelEvent, _nearest_index(), ndarray, QPainter, QPaintEvent, QWidget, _qcolor(), Custom-painted current-pose view with mouse orbit and wheel zoom. (+27 more)

### Community 13 - "VideoStandardLoader"
Cohesion: 0.05
Nodes (46): main(), main(), Loads standard videos, probing metadata and frame timing with PyAV., Score this file as standard video. Two gates, deliberately in this order. A…, Return whether decoded frame timestamps have variable intervals., Return the span the frames actually cover, in master-time seconds., Return ``(is_vfr, measured, min, max)`` from whichever timing is authoritative., Return timestamp-authoritative stream metadata for inspection and OSD. When the… (+38 more)

### Community 14 - "Message"
Cohesion: 0.06
Nodes (50): Headless dataclasses for import statistics and source integrity (D-020). No…, bounded(), Message, Any, Free-text records the acquisition system stored alongside the data.…, One free-text record read from a source file. ``time`` is in the *source's* own…, Return *messages* sorted with untimed records first, capped at the limit.…, Return free-text records this file stores, or an empty list. Additive default,… (+42 more)

### Community 15 - "VideoMetadata"
Cohesion: 0.05
...
### Community 16 - "test_playback_smoothness.py"
Cohesion: 0.06
...
### Community 17 - "export_controller.py"
Cohesion: 0.06
Nodes (52): QWidget, Grab a widget's current visual content as a QPixmap., snapshot_widget(), AnnotationExportWorker, DataExportWorker, Path, QImage, QObject (+44 more)

### Community 18 - "PyramidBuilder"
Cohesion: 0.07
...
### Community 19 - "test_ui_dialogs.py"
Cohesion: 0.06
Nodes (48): _guess_format(), _guess_time_column(), ImportWizard, Path, QDialog, QWidget, Timestamp import wizard with preview, format autodetect, and timezone handling., Return the index of the most likely timestamp column. (+40 more)
...
### Community 21 - "test_pane_proportions.py"
Cohesion: 0.06
...
### Community 24 - "TimeMap"
Cohesion: 0.04
Nodes (31): The source-to-master mapping applied by every method here., ndarray, setter, Maps master timeline to a specific source timeline. t_source = t_master +…, Return the source-time rate relative to master time., Return the local source/master rate around ``t_master``. Exact frame-trigger…, Snap to the nearest accepted frame-trigger timestamp, if available., Return whether exact evidence covers ``t_master``. Affine mappings are… (+23 more)

### Community 25 - "PyramidReader"
Cohesion: 0.06
Nodes (41): PyramidReader, Reads pyramid queries dynamically from mmapped arrays., Open a fresh mmap reader owned by the calling thread., channel(), fixture, Edge behaviour of the pyramid reader and the loader registry. Both sit on paths…, A one-second channel sampled at 100 Hz, with a gap in the middle., `value_at` answers for any time; outside coverage the answer is NaN. (+33 more)

### Community 26 - "PaintCanvas"
Cohesion: 0.06
Nodes (38): color_for_point(), Return the shared colour for the body part called *name*., OverlayTrack, PaintCanvas, Any, QColor, QFont, QPainter (+30 more)

### Community 27 - "TimelineOverview"
Cohesion: 0.06
Nodes (33): QMouseEvent, QPaintEvent, Paint named, conditional timeline-evidence lanes without owning time state., Set the shared master-time range rendered by this overview., Return the distinct pixel columns of the events inside ``[t0, t1]``. Bounded by…, Return the event tuples behind one lane kind. A lookup rather than a…, Binary-search the nearest event of *kind*, or None outside tolerance., Return the clipped timeline span, excluding the source-label gutter. (+25 more)

### Community 28 - "Tracking3DPane"
Cohesion: 0.08
Nodes (43): Timeline-synchronized 3D tracking pane., Use complete XYZ channel triplets from the active cached readers., Say how many points are loaded, and where their bones came from. The provenance…, Reflect the canvas's current orientation without re-triggering it., Pin an explicit vertical axis chosen by the user., Pin which source axis renders upward (see :meth:`Tracking3DCanvas.set_up_axis`)., Set the connectivity the session declared; empty falls back to detection., Pin which skeleton the view draws (see :class:`BoneMode`). (+35 more)

### Community 29 - "main_window.py"
Cohesion: 0.06
Nodes (40): Master timeline and synchronization logic., build_next_video_pane(), load_video(), on_video_open_error(), on_video_opened(), on_video_pane_ready(), on_video_thread_finished(), Any (+32 more)

### Community 30 - "CSVLoader"
Cohesion: 0.07
...
### Community 32 - "NeoLoader"
Cohesion: 0.07
Nodes (28): _fit_length(), _is_numeric_label(), NeoLoader, Any, Exception, ndarray, Return *name* reduced to characters legal in a cache filename everywhere., Return whether an event label is a logic level rather than prose.… (+20 more)

### Community 33 - "VideoSource"
Cohesion: 0.05
Nodes (33): Return all discovered source loaders., ndarray, Yield one-dimensional ``float64`` time/value chunks for *ch*. Chunks, including…, Frozen v1 plugin contract for video sources. ``open`` and optional ``prepare``…, Return True if this source needs proxy conversion (e.g., image seq)., Return an optional UTC-epoch metadata guess; user offset always wins., Return source coverage in master-time seconds. Sources with a metadata start…, Per-frame timestamps if the container has them. (+25 more)

### Community 34 - "test_aol_pose_routing.py"
Cohesion: 0.07
...
### Community 35 - "aol_session_loader.py"
Cohesion: 0.09
Nodes (42): Return all discovered session scanners., One file a session contributes, with the loader and config it needs. ``loader``…, What a recording folder contains, plus the settings that span it. Session-wide…, Optional plugin contract for a whole recording folder. Additive to API v1 and…, SessionItem, SessionLayout, SessionSource, _add_root_videos() (+34 more)

### Community 36 - "generate_guide_screenshots.py"
Cohesion: 0.07
...
### Community 37 - "tracking_3d_pane.py"
Cohesion: 0.07
Nodes (37): Connectivity derived from pose geometry, with the flow it was rooted in.…, True when any connectivity was found., SkeletonEstimate, _build_sources(), _coordinate_name(), detect_up_axis(), _mean_axis_position(), _PointChannels (+29 more)

### Community 38 - "SweepWindowControl"
Cohesion: 0.08
...
### Community 41 - "test_close_and_focus.py"
Cohesion: 0.07
Nodes (42): _playhead_events(), _press(), fixture, Key, parametrize, Path, QApplication, _pyramid_channels() (+34 more)

### Community 42 - "SourceInspection"
Cohesion: 0.09
Nodes (17): ImportReport, IntegrityFlags, Any, All collected inspection data for one loaded source. Not frozen because…, Statistics collected by ImportWorker during one source import., Anomaly flags for one loaded source. Video flags (is_vfr, fps_mismatch) are set…, SourceInspection, create_video_pane() (+9 more)

### Community 43 - "session_controller.py"
Cohesion: 0.07
Nodes (39): MarkerEntry, Session state and JSON serialization for .avv files., Persisted state for one loaded video., Persisted state for one loaded sensor CSV., Persisted annotation marker., SensorEntry, VideoEntry, autosave_before_close() (+31 more)

### Community 44 - "CacheManager"
Cohesion: 0.08
Nodes (28): CacheManager, is_cache_path(), Any, Path, Cache management for sidecar files., Get a temporary directory for writing cache. Ensure atomic swap later., Commit a replacement without discarding the last valid sidecar first., Replace a sidecar's contents without renaming the directory. Individual files… (+20 more)

### Community 45 - "open_ephys_session.py"
Cohesion: 0.08
...
### Community 46 - "test_interaction_standard.py"
Cohesion: 0.06
...
### Community 47 - "AvialSync — Project Blueprint (v1)"
Cohesion: 0.05
...
### Community 48 - "pyramid.py"
Cohesion: 0.07
Nodes (24): _aggregate_gap_mask(), _aggregate_pyramid_level(), _nan_envelope(), ndarray, Path, Pyramid module for decimation and plotting., Aggregate one pyramid level from the preceding level's min/max envelopes., Carry raw discontinuity evidence into one coarser pyramid level. A gap marks… (+16 more)

### Community 49 - "test_core_pyramid.py"
Cohesion: 0.06
Nodes (35): build_gap_mask(), build_pyramid_level(), Return a boolean mask where True indicates a gap larger than 10x median dt.…, Build a decimation level for arrays t and v. Returns (t_decimated, v_min,…, MonkeyPatch, Path, A valid short raw gap cannot disappear merely because the view is coarse., A background sidecar failure must fail the import, never look successful. (+27 more)

### Community 50 - "SessionState"
Cohesion: 0.10
Nodes (32): Complete serialisable state of a AvialSync session. Only stores paths and…, SessionState, Path, QObject, Slot, Background workers for session persistence. Architecture rule 3: the UI thread…, Serialize and write .avv + sidecars off the UI thread., Read and parse .avv + sidecars off the UI thread. Only parsing moves here.… (+24 more)

### Community 51 - "SyncWizard"
Cohesion: 0.07
Nodes (26): EventEvidenceSpec, EvidenceSpec, ndarray, QObject, Background TTL/event evidence extraction and alignment fitting., A cached signal channel from which TTL transitions are extracted., Native timestamp evidence, such as camera-frame trigger timestamps., Build an evidence-based proposal without blocking the UI thread. (+18 more)

### Community 52 - "test_video_pane.py"
Cohesion: 0.08
...
### Community 53 - "ChannelKey"
Cohesion: 0.07
Nodes (31): ChannelKey, disambiguate(), Path, Master-clock presentation of a cached pyramid channel. A…, Stable identity of one channel: its source plus its name. A channel name alone…, Return the display name, qualified by source only when it must be., Return display labels, qualifying only names owned by more than one source., The ``(source_id, channel_id)`` identity of this channel. (+23 more)

### Community 54 - "MappedChannelReader"
Cohesion: 0.08
Nodes (29): MappedChannelReader, Replace the offset/drift mapping in place. Existing plot rows and readout rows…, Return this channel's master-time extent, or None when empty., A pyramid channel presented on the master clock through its ``TimeMap``., The underlying source-time reader., cache_dir(), identity(), fixture (+21 more)

### Community 55 - "test_scrubbing.py"
Cohesion: 0.05
...
### Community 56 - "test_theme_colors.py"
Cohesion: 0.10
...
### Community 58 - "AOLEncoderLoader"
Cohesion: 0.08
Nodes (17): AOLEncoderLoader, Any, Path, Return a single velocity channel. ``rate_hz`` stays ``None``: the logger writes…, Loads AOL encoder logs in bounded chunks. Format: space-separated, no header, 4…, Return high confidence for files matching the encoder log pattern., Validate the file and store config., Unknown channels raise the typed core error, not a bare KeyError. (+9 more)

### Community 59 - "test_worker_lifetime.py"
Cohesion: 0.07
...
### Community 61 - "export.py"
Cohesion: 0.09
Nodes (28): QPixmap, compute_region_stats(), export_data_slice_csv(), export_data_slice_parquet(), Any, ndarray, Path, QImage (+20 more)

### Community 62 - "AOLEksLoader"
Cohesion: 0.09
Nodes (15): AOLEksLoader, Any, Path, Return one ChannelInfo per x/y/z coordinate. EKS rows are one video frame each,…, Tracking Data (2D/3D). Format: standard CSV with header row. Columns follow the…, EKS data is always frame-indexed., Detect EKS CSV by filename pattern and header structure., Read headers and identify x/y/z channels. (+7 more)

### Community 63 - "open_ephys_format.py"
Cohesion: 0.11
Nodes (32): _declared_entries(), _decode(), _event_seconds(), event_stream_defects(), EventStreamDefect, find_record_dir(), _load_array(), parse_record_dir_time() (+24 more)
...
### Community 65 - "VideoStandardProbe"
Cohesion: 0.12
Nodes (31): default_spec(), _message_manifest(), Path, Build a miniature Open Ephys binary recording for tests. Small enough to write…, Write *spec* under *root* and return the ``recording1`` directory., One continuous stream to write into the fixture., A TTL line to write as rising/falling edge pairs., Everything one ``recordingN`` directory should contain. (+23 more)

### Community 66 - "test_ci_platform_config.py"
Cohesion: 0.06
...
### Community 67 - "_apply"
Cohesion: 0.09
Nodes (26): QSettings, main(), restore_geometry(), save_geometry(), QAction, Apply the selected system-relative application font scale., _apply(), apply_font_size() (+18 more)

### Community 68 - "test_loaders_open_ephys_legacy.py"
Cohesion: 0.11
...
### Community 69 - "test_workload_responsiveness.py"
Cohesion: 0.11
Nodes (30): _assert_no_stall_tail(), dense_source(), loaded_window(), _measure(), _measure_each(), _percentile(), fixture, parametrize (+22 more)

### Community 70 - "test_frame_identity.py"
Cohesion: 0.11
Nodes (29): FixtureRequest, Convert a decoded frame to a contiguous ``(H, W, 3)`` uint8 RGB array. Costs…, to_rgb_array(), cfr_video(), _probe_times(), fixture, ndarray, parametrize (+21 more)

### Community 71 - "importer.py"
Cohesion: 0.09
...
### Community 72 - ".load"
Cohesion: 0.10
Nodes (25): Any, Path, Deserialise from a parsed JSON dict (accepts v1 through v6)., Write session JSON and large exact mappings atomically. Small mappings remain…, Read a .avv session file and validate any exact-map sidecars., Serialise to a JSON-compatible dict (always writes version 6)., Path, Tests for SessionState serialisation and schema migrations. (+17 more)

### Community 73 - "test_core_coverage_edges.py"
Cohesion: 0.10
...
### Community 75 - "Path"
Cohesion: 0.11
Nodes (20): is_aol_session(), Return True if the directory has AOL session signature files. An AOL session…, fixture, Path, Tests for AOL loaders (encoder log, EKS 3D tracking, session detection)., Create a minimal encoder_log.txt fixture., Create a minimal EKS CSV fixture with x/y/z columns and fnum., Create an EKS CSV without a fnum column. (+12 more)
...
### Community 77 - "import_controller.py"
Cohesion: 0.09
...
### Community 78 - "theme.py"
Cohesion: 0.15
Nodes (27): _accent(), accent_hue(), evidence_color(), _is_dark_palette(), loop_pin_color(), marker_color(), on_surface(), _palette_with_surfaces() (+19 more)

### Community 79 - "test_ui_sensor_mapping.py"
Cohesion: 0.10
...
### Community 80 - "test_ui_shortcut_reach.py"
Cohesion: 0.11
...
### Community 82 - "PlotInteractionController"
Cohesion: 0.11
...
### Community 89 - "test_tracking_colors.py"
Cohesion: 0.08
...
### Community 90 - "prepare_release.py"
Cohesion: 0.16
...
### Community 91 - "QLabel"
Cohesion: 0.16
Nodes (14): QLabel, _CameraRow, _ChannelReadout, _DeltaRow, QWidget, Cursor readout panel — per-channel values, camera frame numbers, Δ measurement., Show this camera's frame number and media time. Deliberately not called…, Shows Δvalue for one channel. (+6 more)

### Community 92 - "DemoLaunch"
Cohesion: 0.11
...
### Community 94 - "test_aol_chunk_boundaries.py"
Cohesion: 0.16
...
### Community 95 - "test_engine_importer.py"
Cohesion: 0.11
...
### Community 96 - "test_theme_tooltips.py"
Cohesion: 0.08
...
### Community 97 - "test_subprocess_no_window.py"
Cohesion: 0.12
...
### Community 100 - "set_font_family"
Cohesion: 0.11
Nodes (19): Import Report dialog — shows ImportReport stats with a copy-as-text button., _apply_font_to_existing_widgets(), _capture_widget_base_fonts(), _collection_paused(), _live_widgets(), _PaletteStyleFollower, QEvent, QFont (+11 more)

### Community 101 - "._on_evidence_changed"
Cohesion: 0.10
...
### Community 102 - "make_fixtures.py"
Cohesion: 0.14
...
Cohesion: 0.12
Nodes (21): long_gop_video(), fixture, TempPathFactory, encode_frame_index(), ndarray, Frame strip encoder and decoder for robust video sync testing. We encode a…, Encode a 32-bit integer into the top-left pixels of the given frame (in-place).…, Test that we can perfectly round-trip integers through the encoder/decoder. (+13 more)

### Community 104 - "test_ui_layout_resize.py"
Cohesion: 0.12
...
### Community 106 - "TimelineEvidence"
Cohesion: 0.13
...
### Community 111 - "test_never_freeze.py"
Cohesion: 0.14
...
### Community 112 - "open_ephys_legacy.py"
Cohesion: 0.14
...
### Community 113 - "fit_exact_index_mapping"
Cohesion: 0.13
...
### Community 116 - "VideoGrid"
Cohesion: 0.11
Nodes (13): QWidget, Manages N VideoPanes in either a horizontal strip or an NxN grid. Uses a single…, Stop every pane's decoder before their Qt parent is destroyed. Each pane is…, Update the time offset for a specific video., Defer relayout until end_batch_add(). Use for multi-file drops., Toggle fullscreen for the pane identified by *path*. If *path* is None, the…, Toggle fullscreen for the clicked pane., Return a copy of the loaded video paths, parallel to self.panes. (+5 more)

### Community 117 - "test_frame_indexed.py"
Cohesion: 0.14
...
### Community 120 - "_with_messages"
Cohesion: 0.13
Nodes (19): MessageSpec, The ``MessageCenter`` annotation stream — what the experimenter typed. Open…, _messages_dir(), The error a user sees must name the file they have to go and fix. neo decodes…, neo asserts on this one, which is not an error a user can act on., neo warns and skips this one, so the recording still opens and must., Reading the prose ourselves is what makes the text survive the defect., neo picks one seconds-or-sample-numbers rule for the whole recording. The flag… (+11 more)

### Community 121 - "_FakePane"
Cohesion: 0.13
...
### Community 122 - "test_sync_golden.py"
Cohesion: 0.14
...
### Community 124 - "test_player_clock.py"
Cohesion: 0.14
...
### Community 126 - "AvialSync Plot UX Refinement Plan"
Cohesion: 0.12
...
### Community 127 - "drop_controller.py"
Cohesion: 0.15
Nodes (16): drag_enter(), drop_event(), on_drop_scan_error(), on_drop_scan_finished(), on_drop_session_found(), process_drop_candidates(), Path, QDragEnterEvent (+8 more)

### Community 128 - "UiHeartbeat"
Cohesion: 0.12
...
### Community 130 - "test_typed_source_errors.py"
Cohesion: 0.14
...
### Community 131 - "test_ui_plot_sliced_refresh.py"
Cohesion: 0.13
...
### Community 137 - "test_bench_plot_pane.py"
Cohesion: 0.22
...
### Community 138 - "test_demo_data.py"
Cohesion: 0.17
...
### Community 139 - "test_transport_resize.py"
Cohesion: 0.17
...
### Community 141 - "Video Extraction Toolbox — output schema for AvialSync"
Cohesion: 0.13
...
### Community 142 - "Contributor Covenant Code of Conduct"
Cohesion: 0.14
...
### Community 143 - "2026-07 · D-020 · Inspection layer — what is surfaced where"
Cohesion: 0.14
...
### Community 145 - "test_engine_layering.py"
Cohesion: 0.18
...
### Community 149 - "ReadoutPanel"
Cohesion: 0.18
Nodes (7): QGroupBox, Live channel value readout at the current playhead position. Call…, Interpolate and display each channel's value at time *t*., Display A/B-region statistics computed by a background worker., Shows min/max/mean/rms for one channel in a region., ReadoutPanel, _StatsRow
...
### Community 151 - "test_conda_recipe.py"
Cohesion: 0.24
...
### Community 157 - "test_bench_cursor_path"
Cohesion: 0.19
...
### Community 158 - "test_ui_plot_row_geometry.py"
Cohesion: 0.26
...
### Community 159 - "test_video_grid.py"
Cohesion: 0.18
...
### Community 160 - "generate_demo_screenshots.py"
Cohesion: 0.19
...
### Community 161 - "generate_icons.py"
Cohesion: 0.21
...
### Community 163 - "Desktop installers"
Cohesion: 0.17
...
### Community 164 - "AvialSync — Model Handout"
Cohesion: 0.17
...
### Community 165 - "MIGRATION_PYAV.md — libmpv → PyAV, and a pip-only install"
Cohesion: 0.17
...
### Community 167 - "._refresh"
Cohesion: 0.20
Nodes (6): Adopt the window's time display mode, like every other timed widget., Rebuild every row from the store, then apply the current filter. Called when…, Show the rows that match the filter, without rebuilding any of them., Return the file name of *source_id*, falling back to the id itself., Return every message on the master clock, untimed notes first. A recording that…, _source_name()

### Community 168 - ".reset_view"
Cohesion: 0.17
...
### Community 170 - "test_core_sync.py"
Cohesion: 0.17
...
### Community 171 - "test_headless_core.py"
Cohesion: 0.20
...
### Community 173 - "PROMPTS.md — kickoff prompts per phase"
Cohesion: 0.18
...
### Community 175 - "TestPluginDiscovery"
Cohesion: 0.24
...
### Community 176 - "test_prepare_release.py"
Cohesion: 0.27
...
### Community 177 - "Data Output Schema — for AvialSync integration"
Cohesion: 0.20
...
### Community 178 - "no_startup_diagnostics"
Cohesion: 0.20
...
### Community 179 - "2026-07 · D-022 · Interaction standard — visible surface, depth in menus, shortcuts as accelerators"
Cohesion: 0.20
...
### Community 180 - "2. Evidence-based alignment from TTL or frame triggers"
Cohesion: 0.20
...
### Community 181 - "extract_ttl_edges"
Cohesion: 0.24
...
### Community 185 - "_PlotClick"
Cohesion: 0.22
Nodes (5): _PlotClick, Tests for exact master-time seeking from plotted data., Small pyqtgraph scene-click stand-in for the interaction controller., A data-row click selects its absolute time, not just the displayed page., test_clicking_a_plot_seeks_the_shared_master_clock()
...
### Community 191 - "ImportReportDialog"
Cohesion: 0.28
...
### Community 196 - "Sessions, proxies, and the 3D view"
Cohesion: 0.25
...
### Community 197 - "Performance Budgets (engineering-certified where ★)"
Cohesion: 0.25
...
### Community 205 - "Tutorial: import sensor and recording data"
Cohesion: 0.29
...
### Community 207 - "Signal Wiring Map"
Cohesion: 0.29
...
### Community 209 - ".coverage_group_for"
Cohesion: 0.33
...
### Community 214 - "current_preference"
Cohesion: 0.40
...
### Community 217 - "test_packaging_spec.py"
Cohesion: 0.33
...
### Community 218 - "2026-07 · D-032 · Headless CI uses null video, decoded-frame evidence, and explicit mpv ownership — AMENDED by D-075"
Cohesion: 0.40
...
### Community 219 - "2026-07 · D-037 · Releases require a tag reachable from main"
Cohesion: 0.40
...
### Community 220 - "2026-07 · D-043 · Presentation timestamps own video timing and exact interaction"
Cohesion: 0.40
...
### Community 221 - "2026-07 · D-044 · Plot presentation separates review, sweep, and scope"
Cohesion: 0.40
...
### Community 222 - "2026-07 · D-045 · The AOL encoder axis is seconds-since-midnight, unwrapped"
Cohesion: 0.40
...
### Community 223 - "2026-07 · D-046 · Pose data drives the overlay and 3D view, never plot rows"
Cohesion: 0.40
...
### Community 224 - "2026-08 · D-080 · AOL extracted-metric MAT files are detected by filename, not a fixed folder"
Cohesion: 0.40
...
### Community 225 - "2026-08 · D-081 · The video-extraction export is the ROI-metric surface, and it is HDF5"
Cohesion: 0.40
...
### Community 226 - "2026-08 · D-082 · A skeleton is detected from geometry when the data declares none"
Cohesion: 0.40
...
### Community 233 - "test_every_timing_module_samples_perf_counter"
Cohesion: 0.40
...
### Community 234 - "test_three_camera_four_stream_session_can_be_cached_and_queried"
Cohesion: 0.40
...
### Community 235 - "2026-07 · D-033 · Packaging inputs are explicit and CI artifact builds are a separate gate"
Cohesion: 0.50
...
### Community 236 - "2026-07 · D-034 · Themes are palette/font appearance, never interaction redesign"
Cohesion: 0.50
Nodes (4): 2026-07 · D-034 · Themes are palette/font appearance, never interaction redesign, Consequences, Context, Decision

### Community 237 - "2026-07 · D-036 · PR and tag quality use one cross-platform test contract"
Cohesion: 0.50
Nodes (4): 2026-07 · D-036 · PR and tag quality use one cross-platform test contract, Consequences, Context, Decision

### Community 238 - "2026-07 · D-038 · Windows video panes use libmpv's Qt OpenGL render API — SUPERSEDED by D-075"
Cohesion: 0.50
...
### Community 239 - "2026-07 · D-039 · Release bundles own the complete media runtime — AMENDED by D-075"
Cohesion: 0.50
Nodes (4): 2026-07 · D-039 · Release bundles own the complete media runtime — AMENDED by D-075, Consequences, Context, Decision

### Community 240 - "2026-07 · D-040 · Sidecar writes use bounded concurrency and failures remain observable"
Cohesion: 0.50
...
### Community 241 - "2026-07 · D-042 · Plots use one fixed, shared oscilloscope sweep"
Cohesion: 0.50
Nodes (4): 2026-07 · D-042 · Plots use one fixed, shared oscilloscope sweep, Consequences, Context, Decision

### Community 242 - "2026-08 · D-083 · Video-derived data is timed from the camera start, and shares one lane"
Cohesion: 0.50
...
### Community 243 - "2026-08 · D-084 · A seek is answered by its own frame, not by any frame"
Cohesion: 0.50
Nodes (4): 2026-08 · D-084 · A seek is answered by its own frame, not by any frame, Consequences, Context, Decision

### Community 244 - "default_display_name"
Cohesion: 0.50
...
### Community 245 - "_resolved_marker_color"
Cohesion: 0.50
...
### Community 247 - "test_bench_sync.py"
Cohesion: 0.50
...
### Community 248 - "test_packaging_metadata.py"
Cohesion: 0.50
...
### Community 249 - "test_worker_thread_teardown.py"
Cohesion: 0.50
...
- **Why does `MainWindow` connect `MainWindow` to `.resizeEvent`, `PlotPane`, `UiHeartbeat`, `main_window`, `Transport`, `LoaderRegistry`, `ProxyWorker`, `SourceOpenError`, `.__init__`, `PyAVReader`, `VideoStandardLoader`, `Message`, `export_controller.py`, `PyramidBuilder`, `SyncProposal`, `JobManager`, `diagnostics.py`, `test_pane_proportions.py`, `ReadoutPanel`, `TimeMap`, `Tracking3DPane`, `main_window.py`, `generate_demo_screenshots.py`, `VideoSource`, `test_aol_pose_routing.py`, `generate_guide_screenshots.py`, `MasterClock`, `test_close_and_focus.py`, `SourceInspection`, `session_controller.py`, `CacheManager`, `_PointArrays`, `test_interaction_standard.py`, `SessionState`, `SyncWizard`, `ChannelKey`, `DemoWindow`, `_QuickWorker`, `_PlotClick`, `test_worker_lifetime.py`, `ImportReportDialog`, `Path`, `_JobWorker`, `_apply`, `test_workload_responsiveness.py`, `._apply_default_splitter_sizes`, `.add_pane`, `VideoOpenWorker`, `import_controller.py`, `test_ui_sensor_mapping.py`, `test_ui_shortcut_reach.py`, `Player`, `.coverage_group_for`, `AnnotationStore`, `current_preference`, `ShortcutsDialog`, `DemoLaunch`, `_parse_args`, `._accept_sync_proposal`, `.closeEvent`, `demo.py`, `test_ui_layout_resize.py`, `AnnotationPanel`, `.eventFilter`, `test_never_freeze.py`, `VideoGrid`, `test_frame_indexed.py`, `_FakePane`, `test_sync_golden.py`, `MonkeyPatch`, `drop_controller.py`?**
  _High betweenness centrality (0.200) - this node is a cross-community bridge._
- **Why does `PlotPane` connect `PlotPane` to `MainWindow`, `plot_pane.py`, `test_ui_plot_sliced_refresh.py`, `.__init__`, `test_bench_plot_pane.py`, `TestMeasureMarkers`, `TimeMap`, `PlotHeader`, `test_bench_cursor_path`, `main_window.py`, `test_ui_plot_row_geometry.py`, `SweepWindowControl`, `test_close_and_focus.py`, `ChannelKey`, `_JobWorker`, `Player`, `PlotInteractionController`, `AnnotationStore`, `test_ui_follow.py`, `test_theme_tooltips.py`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `LoaderRegistry` connect `LoaderRegistry` to `MainWindow`, `test_loaders_open_ephys.py`, `SourceOpenError`, `.__init__`, `PyramidBuilder`, `test_aol_metric_routing.py`, `PyramidReader`, `main_window.py`, `VideoSource`, `test_aol_pose_routing.py`, `aol_session_loader.py`, `TestPluginDiscovery`, `DummyVideoLoader`, `AOLEncoderLoader`, `AOLEksLoader`, `_JobWorker`, `VideoStandardProbe`, `test_core_coverage_edges.py`, `VideoOpenWorker`, `Path`, `AOLSessionSource`, `.can_open`, `test_frame_indexed.py`, `_with_messages`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Are the 61 inferred relationships involving `MainWindow` (e.g. with `DemoData` and `DemoGenerationWorker`) actually correct?**
  _`MainWindow` has 61 INFERRED edges - model-reasoned connections that need verification._
