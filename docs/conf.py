...
# Furo's source options add the "Edit this page" link on every page; the icon
# below puts the repository itself one click away from the sidebar, which is
# where a furo reader looks for it. Both are theme-supported options rather
    ...
    "footer_icons": [
        {
            ...
            # behind an institutional proxy and leave an empty box.
            "html": (
                ...
                ".29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 "
