...
on the Edit menu's action, like the one in the Data Streams header: the action
is the one author of its label, tooltip, enablement and checked state (rule 15).
"""
